...
function copiar(){   
  ...
  for (i = 0; i < imgOrigen.data.length; i+=4){
      ...
      if(prom<u) blanco_o_negro =0;else blanco_o_negro =255;
      imgResultado.data[i+0] = blanco_o_negro;
      imgResultado.data[i+1] = blanco_o_negro;
      imgResultado.data[i+2] = blanco_o_negro;
